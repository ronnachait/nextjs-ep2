...
function Pokeinfo() {
  ...
  return (
    <div className='p-24'>
        ...
        <div className='flex justify-center items-centermt-10 text-center'>
                        ...
                        <div className='mt-5'>
                            ...
                            <p className='my-3'>
                                ...
                                {poke.abilities?.map(val => (
                                    <span key={val.ability.name} className='bg-gray-500 text-white px-3 py-1 rounded-md ms-2'>{val.ability.name}</span>
                                ))}
                            </p>
                            <p className='my-3'>
                                Type: {""}
                                {poke.types?.map(val => (
                                    <span key={val.type.name} className='bg-gray-500 text-white px-3 py-1 rounded-md ms-2'>{val.type.name}</span>
                                ))}
                            </p>
                        </div>
                    </>
